            ...
            >
                ...
                <div className="mt-6 flex gap-4">
                    <button
                        ...
                        className="w-full rounded-2xl px-6 py-3 text-xs font-bold uppercase tracking-[0.3em] transition-all border focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                    ...
                    <button
                        ...
                        className="w-full rounded-2xl px-6 py-3 text-xs font-bold uppercase tracking-[0.3em] transition-all hover:scale-105 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
