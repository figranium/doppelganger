...
export default function GithubStarPill({ className = '' }: GithubStarPillProps) {
    ...
    return (
        <a
            ...
            className={`gh-pill beam-follow inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.25em] text-white/70 transition hover:border-white/20 hover:bg-white/10 hover:text-white ${className}`}
