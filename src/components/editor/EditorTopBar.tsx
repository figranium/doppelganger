            ...
            <div className="glass-card flex items-center justify-between p-1 px-6 border-b border-white/10 backdrop-blur-xl pointer-events-auto">
                <div className="flex-1 overflow-hidden flex justify-center">
                    <input
                        ...
                        className="bg-transparent border-none text-xs font-bold text-white tracking-[0.08em] focus:outline-none w-full max-w-[400px] text-center placeholder:text-white/20 py-1"
                    />
                </div>
